      ...
      <div className="relative overflow-hidden rounded-3xl border-2 border-amber-400/40 bg-gradient-to-b from-amber-50 to-white p-5 shadow-xl shadow-amber-500/10">
        ...
        {!isRevealed ? (
          <div className="mt-3 flex items-center justify-between text-xs text-amber-800 font-medium">
            <span>✨ Ungli / Touch se rub karke scratch karo!</span>
            <span className="font-bold">{scratchPercent}% scratched</span>
          </div>
        ) : (
          <div className="mt-3 text-center text-xs font-bold text-emerald-700">
            🎉 Offer Unlocked! Show this to merchant cashier at counter.
          </div>
        )}
