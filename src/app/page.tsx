            ...
            <section className="relative min-h-[760px] bg-[radial-gradient(circle_at_50%_8%,rgba(254,226,226,0.6),transparent_44%)] px-5 pb-16 pt-24 text-center sm:pt-28">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                        ...
                        <Link href="/customer/login" className="inline-flex min-w-[174px] items-center justify-center rounded-xl border border-[#e2e2e2] bg-white px-7 py-4 text-sm font-bold shadow-sm transition hover:-translate-y-0.5">I&apos;m a customer</Link>
                    </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#101827]/45 px-5 py-8" role="dialog" aria-modal="true" onClick={() => setShowLoginChoice(false)}>
                    <div className="w-full max-w-md rounded-3xl bg-white p-6 text-left shadow-2xl sm:p-8" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-widest text-[#b20d18]">Welcome to Flinty</p>
                                <h2 className="mt-2 text-2xl font-black">Where would you like to go?</h2>
                                <p className="mt-2 text-sm text-[#718096]">Choose the login that matches how you want to use Flinty.</p>
                            </div>
                        ...
                        <div className="mt-7 grid gap-3">
                            ...
                            <Link href="/customer/login" className="flex w-full items-center justify-between rounded-2xl border border-[#e2e2e2] px-5 py-4 text-left transition hover:border-[#b20d18] hover:bg-[#fff8f8]">
